                        ...
                        <form action="{{ route('users.update', $user->id) }}" method="POST"
                            ...
                            <div class="mb-5">
                                ...
                                <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <option value="{{ App\Utils\GlobalConstant::STATUS_ACTIVE }}" {{ App\Utils\GlobalConstant::STATUS_ACTIVE == $user->status ? 'selected' : '' }}>Active</option>
                                    <option value="{{ App\Utils\GlobalConstant::STATUS_INACTIVE }}" {{ App\Utils\GlobalConstant::STATUS_INACTIVE == $user->status ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
